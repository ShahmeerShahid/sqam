...
STUDENTS_CSV_FILE = os.path.join(sqamv3_path, 'SQAM/Student_Information_and_Submissions_F_2018/students.csv')
STUDENT_GROUPS_FILE = os.path.join(sqamv3_path, 'SQAM/Student_Information_and_Submissions_F_2018/groups.txt')
DIR_AND_NAME_FILE = os.path.join(sqamv3_path, 'SQAM/Student_Information_and_Submissions_F_2018/dirs_and_names.txt')
